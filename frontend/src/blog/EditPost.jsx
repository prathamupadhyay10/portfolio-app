      ...
      <nav className="fixed top-0 w-full bg-black/80 backdrop-blur-xl border-b border-white/5 z-50">
        <div className="max-w-[1600px] mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <h1 className="text-sm font-bold uppercase tracking-widest text-gray-400">Editing Article</h1>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <button 
              ...
              disabled={loading}
              className="flex items-center gap-2 bg-yellow-400 text-black px-8 py-2.5 rounded-xl text-xs font-bold uppercase tracking-widest hover:bg-yellow-500 transition-all duration-500 disabled:bg-gray-800 shadow-lg shadow-yellow-400/20"
            >
              {loading ? <Loader2 size={16} className="animate-spin text-black" /> : <><Save size={16} /> Save Changes</>}
            </button>
          </div>
        </div>
      </nav>
